	...
	<div class="page-header">
		<h3>
			...
			<div class="pull-right">
				<a href="{{{ URL::to('admin/meals/create') }}}" class="btn btn-small btn-info iframe"><span class="glyphicon glyphicon-plus-sign"></span> 添加餐点</a>
			</div>
		</h3>
	</div>

	<table id="meals" class="table table-striped table-hover">
		<thead>
			<tr>
